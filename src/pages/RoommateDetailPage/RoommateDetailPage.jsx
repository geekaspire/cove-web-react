          ...
          <div className="ps-section--single-project ps-project--detail">
            ...
            <div className="ps-project__content">
              <div className="ps-project__block ps-project__desc">
                ...
                <p>
                  Located at the end of a cul-de-sac just a few minutes North of
                  Harrah and the Kickapoo Turnpike between I40 and I44. Cute
                  rustic living space floods with natural light during the day.
                  Open concept kitchen with an eat-in dining area, breakfast
                  bar, large windows, and plenty of storage. The covered front
                  porch is the perfect place to enjoy morning coffee surround by
                  wilderness. 1 car garage, storm shelter, dog pen, and plenty
                  of wildlife. The house has had a metal roof, windows, &amp;
                  HVAC all within the last 10 years.
                </p>
                <p>
                  This 14+ acre site would make an ideal place for your new home
                  with 926 of road frontage. Well already in!! owner has survey
                  wich shows a home and pond! Ideal development parcel, Endless
                  possibilities to enjoy this land. easy access to US 23.A
                  perfect place to build your dream home. Chose the home you
                  want and the landscape as you wish. Bring your horses or
                  llamas! close to shopping.
                </p>
              </div>
              ...
              <div className="ps-project__block">
                ...
                <div className="ps-block--walkscore">
                  <div className="ps-block__top">
                    <p>
                      174 Broadway St, Richmond, San Francisco, CA 5325, USA
                    </p>
                  </div>
                  ...
                  <div className="ps-block__middle">
                      ...
                      <div className="ps-block__right">
                        ...
                        <div className="ps-block__content">
                          <p>
                            ...
                            will definitely be returning. Dave and sue.
                          </p>
                        </div>
                        <div className="ps-block__bottom">
                          <p>
                    ...
                    <div className="ps-block--agent-review">
                      ...
                      <div className="ps-block__right">
                        ...
                        <div className="ps-block__content">
                          <p>
                            Great experience overall. Love the user interface
                            and usability
                          </p>
                        </div>
                        <div className="ps-block__bottom">
